...
gj.grid.config = {
    base: {
        ...
        defaultColumnSettings: {
             ...
             *             {
             *               title: '', field: 'Info', width: 32, type: 'icon', icon: 'glyphfa fa-info-sign',
             *               events: {
             *                 'click': function (e) {
             ...
             *             { field: 'Name' },
             *             { field: 'PlaceOfBirth' },
             *             { title: '', field: 'Edit', width: 32, type: 'icon', icon: 'glyphfa fa-pencil', events: { 'click': function (e) { alert('name=' + e.data.record.Name); } } }
             *         ]
             *     });
             * </script>
             */
             ...
             *             { field: 'PlaceOfBirth' },
             *             {
             *               title: '', field: 'Info', width: 34, type: 'icon', icon: 'glyphfa fa-info-sign',
             *               events: {
             *                 'click': function (e) {
             *                     alert('record with id=' + e.data.id + ' is clicked.'); }
             *                 }
             ...
             *             <th data-events="click: onClick" data-type="icon" data-icon="glyphfa fa-info-sign" width="32"></th>
             *         </tr>
             *     </thead>
             * </table>
             * <script>
    ...
    glyphicons: {
        icons: {
            asc: '<span class="glyphicon glyphfa fa-sort-by-alphabet" />',
            desc: '<span class="glyphicon glyphfa fa-sort-by-alphabet-alt" />'
        }
    }
};
...
gj.grid.plugins.expandCollapseRows = {
    config: {
        ...
        glyphicons: {
            icons: {
                expandRow: '<span class="glyphicon glyphfa fa-chevron-right" />',
                collapseRow: '<span class="glyphicon glyphfa fa-chevron-down" />'
            }
        }
    },
...
gj.grid.plugins.inlineEditing.private = {
    localization: function (data) {
        if (data.uiLibrary === 'bootstrap') {
            data.inlineEditing.editButton = '<button type="button" class="btn btn-default btn-sm"><span class="glyphicon glyphfa fa-pencil" aria-hidden="true"></span> ' + gj.grid.messages[data.locale].Edit + '</button>';
            data.inlineEditing.deleteButton = '<button type="button" class="btn btn-default btn-sm gj-margin-left-10"><span class="glyphicon glyphfa fa-remove" aria-hidden="true"></span> ' + gj.grid.messages[data.locale].Delete + '</button>';
            data.inlineEditing.updateButton = '<button type="button" class="btn btn-default btn-sm"><span class="glyphicon glyphfa fa-ok" aria-hidden="true"></span> ' + gj.grid.messages[data.locale].Update + '</button>';
            data.inlineEditing.cancelButton = '<button type="button" class="btn btn-default btn-sm gj-margin-left-10"><span class="glyphicon glyphfa fa-ban-circle" aria-hidden="true"></span> ' + gj.grid.messages[data.locale].Cancel + '</button>';
        } else {
...
gj.grid.plugins.pagination = {
    config: {
        ...
        glyphicons: {
            icons: {
                first: '<span class="glyphicon glyphfa fa-step-backward"></span>',
                previous: '<span class="glyphicon glyphfa fa-backward"></span>',
                next: '<span class="glyphicon glyphfa fa-forward"></span>',
                last: '<span class="glyphicon glyphfa fa-step-forward"></span>',
                refresh: '<span class="glyphicon glyphfa fa-refresh"></span>'
            }
        },
...
gj.grid.plugins.grouping = {
    config: {
        ...
        glyphicons: {
            icons: {
                expandGroup: '<span class="glyphicon glyphfa fa-plus" />',
                collapseGroup: '<span class="glyphicon glyphfa fa-minus" />'
            }
        }
    },
...
gj.tree.config = {
    base: {
         ...
         *     var tree = $('#tree').tree({
         *         uiLibrary: 'bootstrap',
         *         dataSource: [ { text: 'folder', imageCssClass: 'glyphicon glyphfa fa-folder-close', children: [ { text: 'file', imageCssClass: 'glyphicon glyphfa fa-file' } ] } ]
         *     });
         * </script>
    ...
    glyphicons: {
        ...
        icons: {
            expand: '<span class="glyphicon glyphfa fa-plus" />',
            collapse: '<span class="glyphicon glyphfa fa-minus" />'
        }
    }
};
/**
	...
	config: {
        ...
        bootstrap: {
            style: {
                ...
                dropAsChildIcon: 'glyphicon glyphfa fa-plus',
...
gj.dropdown.config = {
    base: {
        ...
        icons: {
             ...
             *         width: 200,
             *         icons: { 
             *             dropdown: '<span class="glyphicon glyphfa fa-triangle-bottom" />'
             *         }
             *     });
             * </script>
             */
...
gj.datepicker.config = {
    base: {
        ...
        icons: {
             ...
             *         uiLibrary: 'bootstrap',
             *         icons: {
             *             rightIcon: '<span class="input-group-addon" role="right-icon"><span class="glyphicon glyphfa fa-chevron-down"></span></span>'
             *         }
             *     });
             * </script>
    ...
    glyphicons: {
        icons: {
            rightIcon: '<span class="glyphicon glyphfa fa-calendar"></span>',
            previousMonth: '<span class="glyphicon glyphfa fa-chevron-left"></span>',
            nextMonth: '<span class="glyphicon glyphfa fa-chevron-right"></span>'
        }
    }
};
